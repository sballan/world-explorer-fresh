...
import type { ILLMClient } from "./llm-client-interface.ts";
import { CloudLLMClient } from "./llm-client.ts";
...
/**
 * Default adapter for world generation using the LLM client
 */
...
/**
 * Default adapter for action narration using the LLM client
 */
...
/**
 * Default adapter for action selection using the LLM client
 */
...
/**
 * Default adapter for discovery generation using the LLM client
 */
